...
def monetization_revenue_analytics():
    ...
    rows = connection.execute(
        ...
        FROM monetization_payments p

        LEFT JOIN brand_enquiries b
            ON b.id = p.lead_id
...
@monetization_admin_bp.route(
    "/monetization/export-payments.csv"
)
def export_monetization_payments():
    ...
    filename = (
        "raj_raushan_earnings_report.csv"
    )
